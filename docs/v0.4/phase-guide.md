...
**Contributors:** scheduling consolidates; DO provides priorities/intent; Flt CCs provide personnel effects; training, maintenance and support owners supply their existing products. The assistant may draft missing forms and answer planning questions. It does not create a full lineup.
...
**Outputs:** normalized facts and gaps; bounded Q&A; priorities supported by evidence; prerequisite/window/resource demand; missing guidance clearly marked Proposed. Capture an early checkride opportunity caused by future absence without inventing a new due date.
...
**Advance:** scheduler discretion or explicit statement that drafting has begun. **Carry:** current manifest, local profile/playbook, confirmed guidance, human confirmations and unresolved items with affected checks. Active schedule/baseline may still be None.

## 2. Initial draft

**Contributors:** schedulers build and edit the lineup; assistant reviews; DO/Flt CC/training/resource owners resolve their issues.
...
**Outputs:** hard conflicts, approval needs, exact improvements and fully revalidated cascades; primary-line/spare/configuration/formation/backup analysis; upgrade flow, 30-day outlook, comparable IP workload and moderate downside scenario. BRIEF and DETAILED adjust depth without changing policy.
...
**Contributors:** schedulers present; DO reviews and directs; assistant prepares decision support and records the human directions.

**Inputs now:** exact presented version, latest evidence/limits, priorities/outlook, alternatives and unresolved decisions. **Provisional:** correction proposals and unresolved resource facts; do not hide them as confirmed feasibility.
...
## 4. Corrections, final QC, DO buy and publication

**Contributors:** schedulers edit; assistant checks; humans close findings; DO formally buys; humans publish through the normal distribution process.
...
**Contributors:** daily scheduler and Top 3 provide current facts and sign daily schedules; source owners update products; DO handles changes beyond delegation and every waiver; assistant analyzes.
...
Prefer one weekly conversation; use the handoff form when needed. Preserve the original published weekly baseline unless humans explicitly select a new publication after reissue. Every affected daily baseline has its own date. If two users submit competing changes, reconcile them as proposals against the identified current versions; do not assume the last uploaded filename wins.
