...
No draft exists yet? That is normal. Missing a product? Tell the assistant. It will explain the limitation and continue the work it can do. Use **02 DO Weekly Guidance.docx** and **03 Flight Commander Input.docx** from **System → Blank Forms** only for direction and information not already captured elsewhere.
