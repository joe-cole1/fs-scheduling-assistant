...
Before using a calculated workbook for person-specific conclusions, verify that
its displayed person, stable identifier, source date, formulas, duplicate-name
handling, and missing/error states are reliable. A material identity or formula
defect is INTEGRITY FAILED. Do not use affected cached values merely because they
look plausible; continue unaffected analysis.
