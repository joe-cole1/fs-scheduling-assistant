...
- The exact schedule version intended for the sell.
...
- Applicable local rules and references.
...
If the DO accepts a finding, return the human decision to the normal Gemini conversation in this form:
