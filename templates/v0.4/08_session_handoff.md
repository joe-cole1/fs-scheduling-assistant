...
- Week / as-of / timezone: [values]
- Active phase / parallel work: [values]
- Outgoing user / next owner if known: [values]
- Next requested action: [value]
- System / local profile / stable-reference / approved-playbook versions: [values]
- Test condition / cutoff / permitted actual-results scope: [values]
- Blind integrity: [clean / contaminated → MUST NOT resume blind review here]
...
| Event/cohort | Completed results/credit | Remaining firm commitments | Conditional opportunities/triggers | Changed facts and sources | Outlook/bottleneck |
| --- | --- | --- | --- | --- | --- |
